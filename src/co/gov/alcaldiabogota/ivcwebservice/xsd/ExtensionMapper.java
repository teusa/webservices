...
public class ExtensionMapper {
    public static java.lang.Object getTypeObject(
        ...
        if ("http://ivcWebService.alcaldiabogota.gov.co/xsd".equals(
                    namespaceURI) && "Establecimiento".equals(typeName)) {
            return co.gov.alcaldiabogota.ivcwebservice.xsd.Establecimiento.Factory.parse(reader);
        }
        ...
        if ("http://ivcWebService.alcaldiabogota.gov.co/xsd".equals(
                    namespaceURI) && "Busqueda".equals(typeName)) {
            return co.gov.alcaldiabogota.ivcwebservice.xsd.Busqueda.Factory.parse(reader);
        }
