...
public class IvcWebServiceException extends co.gov.alcaldiabogota.ivcwebservice.Exception
    implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = IvcWebServiceException
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":IvcWebServiceException", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "IvcWebServiceException", xmlWriter);
        }
        ...
        if (localExceptionTracker) {
            if (localException != null) {
                ...
                writeStartElement(null,
                    "http://ivcWebService.alcaldiabogota.gov.co", "Exception",
                    xmlWriter);
            ...
            try {
                ...
                if ((reader.isStartElement() &&
                    ...
                    object.setException(org.apache.axis2.databinding.utils.ConverterUtil.getAnyTypeObject(
                            reader,
                            co.gov.alcaldiabogota.ivcwebservice.xsd.ExtensionMapper.class));
